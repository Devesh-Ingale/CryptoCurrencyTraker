    ...
    fun LineChart(
        ...
        var drawPoints by remember(dataPoints, visibleDataPointsIndices) {
            mutableStateOf(dataPoints.slice(visibleDataPointsIndices))
        }
        ...
        Canvas(modifier = modifier
            ...
            for(i in 1 until drawPoints.size){
                ...
                val y1=p0.y
                val y2=p1.y
                conPoints1.add(DataPoint(
                    x=x,
                    y=y1,
                    xLabel = ""
                ))
                conPoints2.add(DataPoint(
                    x=x,
                    y=y2,
                    xLabel = ""
                ))
