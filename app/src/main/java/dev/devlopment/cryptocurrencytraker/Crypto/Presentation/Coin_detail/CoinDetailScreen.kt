package dev.devlopment.cryptocurrencytraker.Crypto.Presentation.Coin_detail
...
import dev.devlopment.cryptocurrencytraker.Crypto.Presentation.CoinList.CoinListState
import dev.devlopment.cryptocurrencytraker.Crypto.Presentation.CoinList.Components.previewCoin
import dev.devlopment.cryptocurrencytraker.Crypto.Presentation.Coin_detail.components.InfoCard
import dev.devlopment.cryptocurrencytraker.Crypto.Presentation.Models.toDisplayableNumber
...
import dev.devlopment.cryptocurrencytraker.ui.theme.greenBackground
    ...
    if (state.isLoading){
        ...
        Column(
            ...
            FlowRow (
                ...
                InfoCard(
                    title = stringResource(R.string.marketCap),
                ...
                InfoCard(
                    title = stringResource(R.string.ChangeLas24Hr),
